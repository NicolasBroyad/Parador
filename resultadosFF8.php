...
<html>
    ...
    <body>
        ...
        include("header.php");
        include("inscripcion_sql_FF8.php");
        ...
        if(mysqli_num_rows($resultado_octavos) < 8) {
            ...
            <form action="#" method="post">
                <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8octavos1' AND `id_torneo` = '$id_torneo'";
        ...
        <!-- OCTAVOS 2 !-->
            ...
            <form action="resultadosFF8.php#confirmar_octavos1" method="post">
            <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8octavos2' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
                if(mysqli_num_rows($resultado) > 0){
                    $partido = mysqli_fetch_row($resultado);
                    $id_equipo1 = $partido[0];
        ...
        <!-- OCTAVOS 3 !-->
            ...
            <form action="resultadosFF8.php#octavos2" method="post">
            <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8octavos3' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
                if(mysqli_num_rows($resultado) > 0){
                    $partido = mysqli_fetch_row($resultado);
                    $id_equipo1 = $partido[0];
        ...
        <!-- OCTAVOS 4 !-->
            ...
            <form action="resultadosFF8.php#confirmar_octavos3" method="post">
                <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8octavos4' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
                if(mysqli_num_rows($resultado) > 0){
                    $partido = mysqli_fetch_row($resultado);
                    $id_equipo1 = $partido[0];
        ...
        <!-- OCTAVOS 5 !-->
            ...
            <form action="resultadosFF8.php#confirmar_octavos4" method="post">
            <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8octavos5' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
                if(mysqli_num_rows($resultado) > 0){
                    $partido = mysqli_fetch_row($resultado);
                    $id_equipo1 = $partido[0];
        ...
        <!-- OCTAVOS 6 !-->
            ...
            <form action="resultadosFF8.php#confirmar_octavos5" method="post">
            <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8octavos6' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
                if(mysqli_num_rows($resultado) > 0){
                    $partido = mysqli_fetch_row($resultado);
                    $id_equipo1 = $partido[0];
        ...
        <!-- OCTAVOS 7 !-->
            ...
            <form action="resultadosFF8.php#confirmar_octavos6" method="post">
            <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8octavos7' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
                if(mysqli_num_rows($resultado) > 0){
                    $partido = mysqli_fetch_row($resultado);
                    $id_equipo1 = $partido[0];
        ...
        <!-- OCTAVOS 8 !-->
            ...
            <form action="resultadosFF8.php#confirmar_octavos7" method="post">
            <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8octavos8' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
                if(mysqli_num_rows($resultado) > 0){
                    $partido = mysqli_fetch_row($resultado);
                    $id_equipo1 = $partido[0];
        ...
        // COMIENZA LA FASE DE CUARTOS, CUARTOS 1 
            ...
            <form action="#" method="post">
                <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8cuartos1' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
                if(mysqli_num_rows($resultado) > 0){
                    $partido = mysqli_fetch_row($resultado);
                    $id_equipo1 = $partido[0];
            ...
            <form action="resultadosFF8.php#confirmar_cuartos1" method="post">
                <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8cuartos2' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
                if(mysqli_num_rows($resultado) > 0){
                    $partido = mysqli_fetch_row($resultado);
                    $id_equipo1 = $partido[0];
            ...
            <form action="resultadosFF8.php#confirmar_cuartos2" method="post">
                <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8cuartos3' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
                if(mysqli_num_rows($resultado) > 0){
                    $partido = mysqli_fetch_row($resultado);
                    $id_equipo1 = $partido[0];
            ...
            <form action="resultadosFF8.php#confirmar_cuartos3" method="post">
                <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8cuartos4' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
            ...
            <form action="#" method="post">
                <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8semis1' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
                if(mysqli_num_rows($resultado) > 0){
                    $partido = mysqli_fetch_row($resultado);
                    $id_equipo1 = $partido[0];
            ...
            <form action="resultadosFF8.php#confirmar_semis1" method="post">
                <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8semis2' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
                if(mysqli_num_rows($resultado) > 0){
                    $partido = mysqli_fetch_row($resultado);
                    $id_equipo1 = $partido[0];
            ...
            <form action="#" method="post">
                <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8final' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
                if(mysqli_num_rows($resultado) > 0){
                    $partido = mysqli_fetch_row($resultado);
                    $id_equipo1 = $partido[0];
