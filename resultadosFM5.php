...
<html>
    ...
    <body>
        ...
        include("header.php");
        include("inscripcion_sql_FM5.php");
        ...
        if(mysqli_num_rows($resultado_octavos) < 8) {
            ...
            <form action="#" method="post">
                <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5octavos1' AND `id_torneo` = '$id_torneo'";
        ...
        <!-- OCTAVOS 2 !-->
            ...
            <form action="resultadosFM5.php#confirmar_octavos1" method="post">
            <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5octavos2' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
                if(mysqli_num_rows($resultado) > 0){
                    $partido = mysqli_fetch_row($resultado);
                    $id_equipo1 = $partido[0];
        ...
        <!-- OCTAVOS 3 !-->
            ...
            <form action="resultadosFM5.php#octavos2" method="post">
            <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5octavos3' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
                if(mysqli_num_rows($resultado) > 0){
                    $partido = mysqli_fetch_row($resultado);
                    $id_equipo1 = $partido[0];
        ...
        <!-- OCTAVOS 4 !-->
            ...
            <form action="resultadosFM5.php#confirmar_octavos3" method="post">
                <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5octavos4' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
                if(mysqli_num_rows($resultado) > 0){
                    $partido = mysqli_fetch_row($resultado);
                    $id_equipo1 = $partido[0];
        ...
        <!-- OCTAVOS 5 !-->
            ...
            <form action="resultadosFM5.php#confirmar_octavos4" method="post">
            <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5octavos5' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
                if(mysqli_num_rows($resultado) > 0){
                    $partido = mysqli_fetch_row($resultado);
                    $id_equipo1 = $partido[0];
        ...
        <!-- OCTAVOS 6 !-->
            ...
            <form action="resultadosFM5.php#confirmar_octavos5" method="post">
            <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5octavos6' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
                if(mysqli_num_rows($resultado) > 0){
                    $partido = mysqli_fetch_row($resultado);
                    $id_equipo1 = $partido[0];
        ...
        <!-- OCTAVOS 7 !-->
            ...
            <form action="resultadosFM5.php#confirmar_octavos6" method="post">
            <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5octavos7' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
                if(mysqli_num_rows($resultado) > 0){
                    $partido = mysqli_fetch_row($resultado);
                    $id_equipo1 = $partido[0];
        ...
        <!-- OCTAVOS 8 !-->
            ...
            <form action="resultadosFM5.php#confirmar_octavos7" method="post">
            <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5octavos8' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
                if(mysqli_num_rows($resultado) > 0){
                    $partido = mysqli_fetch_row($resultado);
                    $id_equipo1 = $partido[0];
        ...
        // COMIENZA LA FASE DE CUARTOS, CUARTOS 1 
            ...
            <form action="#" method="post">
                <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5cuartos1' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
                if(mysqli_num_rows($resultado) > 0){
                    $partido = mysqli_fetch_row($resultado);
                    $id_equipo1 = $partido[0];
            ...
            <form action="resultadosFM5.php#confirmar_cuartos1" method="post">
                <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5cuartos2' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
                if(mysqli_num_rows($resultado) > 0){
                    $partido = mysqli_fetch_row($resultado);
                    $id_equipo1 = $partido[0];
            ...
            <form action="resultadosFM5.php#confirmar_cuartos2" method="post">
                <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5cuartos3' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
                if(mysqli_num_rows($resultado) > 0){
                    $partido = mysqli_fetch_row($resultado);
                    $id_equipo1 = $partido[0];
            ...
            <form action="resultadosFM5.php#confirmar_cuartos3" method="post">
                <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5cuartos4' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
            ...
            <form action="#" method="post">
                <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5semis1' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
                if(mysqli_num_rows($resultado) > 0){
                    $partido = mysqli_fetch_row($resultado);
                    $id_equipo1 = $partido[0];
            ...
            <form action="resultadosFM5.php#confirmar_semis1" method="post">
                <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5semis2' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
                if(mysqli_num_rows($resultado) > 0){
                    $partido = mysqli_fetch_row($resultado);
                    $id_equipo1 = $partido[0];
            ...
            <form action="#" method="post">
                <?php
                $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5final' AND `id_torneo` = '$id_torneo'";
                $resultado = mysqli_query($conex,$consulta);
                if(mysqli_num_rows($resultado) > 0){
                    $partido = mysqli_fetch_row($resultado);
                    $id_equipo1 = $partido[0];
