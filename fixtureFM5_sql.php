...
function ingreso_fixture_octavos1() {
    ...
    if(isset($_POST["confirmar_octavos1"])){
        if(isset($_POST["equipo1_octavos"]) && isset($_POST["equipo2_octavos"])){
            ...
            $hora = $_POST["hora"];
            $etapa = "octavos";
            $subetapa = "FM5octavos1";
            $id_torneo = obtener_id_torneo(); //id torneo

            $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5octavos1'"; //Buscar si esta subetapa ya tiene un partido agendado
            ...
            if(mysqli_fetch_row($resultado_subetapa) == 0){
                ...
                $consulta_fecha = "SELECT * FROM `torneos` WHERE `sexo` = 'masculino' AND `cant_jugadores` = '5' ";
                ...
                if($fecha_inicial <= $fecha && $fecha <= $fecha_final){
                    ...
                    $consulta_hora = "SELECT * FROM `torneos` WHERE `sexo` = 'masculino' AND `cant_jugadores` = '5' ";
...
function ingreso_fixture_octavos2() {
    ...
    if(isset($_POST["confirmar_octavos2"])){
        if(isset($_POST["equipo1_octavos"]) && isset($_POST["equipo2_octavos"])){
            ...
            $hora = $_POST["hora"];
            $etapa = "octavos";
            $subetapa = "FM5octavos2";
            $id_torneo = obtener_id_torneo(); //id torneo

            $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5octavos2'"; //Buscar si esta subetapa ya tiene un partido agendado
            $resultado_subetapa = mysqli_query($conex,$consulta);
...
function ingreso_fixture_octavos3() {
    ...
    if(isset($_POST["confirmar_octavos3"])){
        if(isset($_POST["equipo1_octavos"]) && isset($_POST["equipo2_octavos"])){
            ...
            $hora = $_POST["hora"];
            $etapa = "octavos";
            $subetapa = "FM5octavos3";
            $id_torneo = obtener_id_torneo(); //id torneo

            $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5octavos3'"; //Buscar si esta subetapa ya tiene un partido agendado
            $resultado_subetapa = mysqli_query($conex,$consulta);
...
function ingreso_fixture_octavos4() {
    ...
    if(isset($_POST["confirmar_octavos4"])){
        if(isset($_POST["equipo1_octavos"]) && isset($_POST["equipo2_octavos"])){
            ...
            $hora = $_POST["hora"];
            $etapa = "octavos";
            $subetapa = "FM5octavos4";
            $id_torneo = obtener_id_torneo(); //id torneo

            $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5octavos4'"; //Buscar si esta subetapa ya tiene un partido agendado
            $resultado_subetapa = mysqli_query($conex,$consulta);
...
function ingreso_fixture_octavos5() {
    ...
    if(isset($_POST["confirmar_octavos5"])){
        if(isset($_POST["equipo1_octavos"]) && isset($_POST["equipo2_octavos"])){
            ...
            $hora = $_POST["hora"];
            $etapa = "octavos";
            $subetapa = "FM5octavos5";
            $id_torneo = obtener_id_torneo(); //id torneo

            $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5octavos5'"; //Buscar si esta subetapa ya tiene un partido agendado
            $resultado_subetapa = mysqli_query($conex,$consulta);
...
function ingreso_fixture_octavos6() {
    ...
    if(isset($_POST["confirmar_octavos6"])){
        if(isset($_POST["equipo1_octavos"]) && isset($_POST["equipo2_octavos"])){
            ...
            $hora = $_POST["hora"];
            $etapa = "octavos";
            $subetapa = "FM5octavos6";
            $id_torneo = obtener_id_torneo(); //id torneo

            $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5octavos6'"; //Buscar si esta subetapa ya tiene un partido agendado
            $resultado_subetapa = mysqli_query($conex,$consulta);
...
function ingreso_fixture_octavos7() {
    ...
    if(isset($_POST["confirmar_octavos7"])){
        if(isset($_POST["equipo1_octavos"]) && isset($_POST["equipo2_octavos"])){
            ...
            $hora = $_POST["hora"];
            $etapa = "octavos";
            $subetapa = "FM5octavos7";
            $id_torneo = obtener_id_torneo(); //id torneo

            $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5octavos7'"; //Buscar si esta subetapa ya tiene un partido agendado
            $resultado_subetapa = mysqli_query($conex,$consulta);
...
function ingreso_fixture_octavos8() {
    ...
    if(isset($_POST["confirmar_octavos8"])){
        if(isset($_POST["equipo1_octavos"]) && isset($_POST["equipo2_octavos"])){
            ...
            $hora = $_POST["hora"];
            $etapa = "octavos";
            $subetapa = "FM5octavos8";
            $id_torneo = obtener_id_torneo(); //id torneo

            $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5octavos8'"; //Buscar si esta subetapa ya tiene un partido agendado
            $resultado_subetapa = mysqli_query($conex,$consulta);
...
function ingreso_fixture_cuartos1() {
    ...
    if(isset($_POST["confirmar_cuartos1"])){
        if(isset($_POST["equipo1_cuartos"]) && isset($_POST["equipo2_cuartos"])){
            ...
            $hora = $_POST["hora"];
            $etapa = "cuartos";
            $subetapa = "FM5cuartos1";
            $id_torneo = obtener_id_torneo(); //id torneo

            $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5cuartos1'"; //Buscar si esta subetapa ya tiene un partido agendado
            $resultado_subetapa = mysqli_query($conex,$consulta);
...
function ingreso_fixture_cuartos2() {
    ...
    if(isset($_POST["confirmar_cuartos2"])){
        if(isset($_POST["equipo1_cuartos"]) && isset($_POST["equipo2_cuartos"])){
            ...
            $hora = $_POST["hora"];
            $etapa = "cuartos";
            $subetapa = "FM5cuartos2";
            $id_torneo = obtener_id_torneo(); //id torneo

            $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5cuartos2'"; //Buscar si esta subetapa ya tiene un partido agendado
            $resultado_subetapa = mysqli_query($conex,$consulta);
...
function ingreso_fixture_cuartos3() {
    ...
    if(isset($_POST["confirmar_cuartos3"])){
        if(isset($_POST["equipo1_cuartos"]) && isset($_POST["equipo2_cuartos"])){
            ...
            $hora = $_POST["hora"];
            $etapa = "cuartos";
            $subetapa = "FM5cuartos3";
            $id_torneo = obtener_id_torneo(); //id torneo

            $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5cuartos3'"; //Buscar si esta subetapa ya tiene un partido agendado
            $resultado_subetapa = mysqli_query($conex,$consulta);
...
function ingreso_fixture_cuartos4() {
    ...
    if(isset($_POST["confirmar_cuartos4"])){
        if(isset($_POST["equipo1_cuartos"]) && isset($_POST["equipo2_cuartos"])){
            ...
            $hora = $_POST["hora"];
            $etapa = "cuartos";
            $subetapa = "FM5cuartos4";
            $id_torneo = obtener_id_torneo(); //id torneo

            $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5cuartos4'"; //Buscar si esta subetapa ya tiene un partido agendado
            $resultado_subetapa = mysqli_query($conex,$consulta);
...
function ingreso_fixture_semis1() {
    ...
    if(isset($_POST["confirmar_semis1"])){
        if(isset($_POST["equipo1_semis"]) && isset($_POST["equipo2_semis"])){
            ...
            $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5semis1'"; //Buscar si esta subetapa ya tiene un partido agendado
            $resultado_subetapa = mysqli_query($conex,$consulta);
...
function ingreso_fixture_semis2() {
    ...
    if(isset($_POST["confirmar_semis2"])){
        if(isset($_POST["equipo1_semis"]) && isset($_POST["equipo2_semis"])){
            ...
            $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5semis2'"; //Buscar si esta subetapa ya tiene un partido agendado
            $resultado_subetapa = mysqli_query($conex,$consulta);
...
function ingreso_fixture_final() {
    ...
    if(isset($_POST["confirmar_final"])){
        if(isset($_POST["equipo1_final"]) && isset($_POST["equipo2_final"])){
            ...
            $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5final'"; //Buscar si esta subetapa ya tiene un partido agendado
            $resultado_subetapa = mysqli_query($conex,$consulta);
...
function obtener_equipos_octavosFM5(){
    $conex = conex();
    $id_torneo = obtener_id_torneo(); //id torneo
...
function mostrar_equipos_octavos(){
    $lista_ids = obtener_equipos_octavosFM5();
...
function obtener_equipos_cuartosFM5(){
    $conex = conex();
    $id_torneo = obtener_id_torneo(); //id torneo
...
function mostrar_equipos_cuartos(){
    $lista_ids = obtener_equipos_cuartosFM5();
...
function obtener_equipos_semisFM5(){
    $conex = conex();
    $id_torneo = obtener_id_torneo(); //id torneo
...
function mostrar_equipos_semis(){
    $lista_ids = obtener_equipos_semisFM5();
...
function obtener_equipos_finalFM5(){
    $conex = conex();
    $id_torneo = obtener_id_torneo(); //id torneo
...
function mostrar_equipos_final(){
    $lista_ids = obtener_equipos_finalFM5();
