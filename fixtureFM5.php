    ...
    <body>
        ...
        if(mysqli_num_rows($resultado_cant_octavos) < 8){ // CHEQUEAR SI YA SE AGENDARON LOS 8 OCTAVOS
            ?>
                ...
                <form action="fixtureFM5.php#confirmar_octavos1" method="post">
                    <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5octavos1'";
                ...
                <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5octavos2'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
                        <div id="fecha1" class="partidos_div">
                ...
                <form action="fixtureFM5.php#confirmar_octavos2" method="post">
                <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5octavos3'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
                        <div id="fecha1" class="partidos_div">
                ...
                <form action="fixtureFM5.php#confirmar_octavos3" method="post">
                <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5octavos4'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
                        <div id="fecha1" class="partidos_div">
                ...
                <form action="fixtureFM5.php#confirmar_octavos4" method="post">
                <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5octavos5'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
                        <div id="fecha1" class="partidos_div">
                ...
                <form action="fixtureFM5.php#confirmar_octavos5" method="post">
                <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5octavos6'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
                        <div id="fecha1" class="partidos_div">
                ...
                <form action="fixtureFM5.php#confirmar_octavos6" method="post">
                <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5octavos7'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
                        <div id="fecha1" class="partidos_div">
                ...
                <form action="fixtureFM5.php#confirmar_octavos7" method="post">
                <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5octavos8'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
                        <div id="fecha1" class="partidos_div">
...
<!-- SE TERMINA LA FASE DE OCTAVOS Y COMIENZA LA FASE DE CUARTOS  !-->
            ...
            <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5cuartos1'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
            ...
            <form action="fixtureFM5.php#confirmar_cuartos1" method="post">
            <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5cuartos2'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
                        <div id="fecha2" class="partidos_div">
            ...
            <form action="fixtureFM5.php#confirmar_cuartos2" method="post">
            <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5cuartos3'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
                        <div id="fecha2" class="partidos_div">
            ...
            <form action="fixtureFM5.php#confirmar_cuartos3" method="post">
            <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5cuartos4'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
                        <div id="fecha2" class="partidos_div">
            ...
            <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5semis1'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
            ...
            <form action="fixtureFM5.php#confirmar_semis1" method="post">
            <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5semis2'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
                        <div id="fecha3" class="partidos_div">
...
<!-- TERMINA LA FASE DE SEMIFINALES Y COMIENZA LA FASE FINAL  !-->
            ...
            <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FM5final'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
                        <div id="fecha3" class="partidos_div">
