    ...
    <body>
        ...
        if(mysqli_num_rows($resultado_cant_octavos) < 8){ // CHEQUEAR SI YA SE AGENDARON LOS 8 OCTAVOS
            ?>
                ...
                <form action="fixtureFF8.php#confirmar_octavos1" method="post">
                    <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8octavos1'";
                ...
                <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8octavos2'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
                        <div id="fecha1" class="partidos_div">
                ...
                <form action="fixtureFF8.php#confirmar_octavos2" method="post">
                <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8octavos3'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
                        <div id="fecha1" class="partidos_div">
                ...
                <form action="fixtureFF8.php#confirmar_octavos3" method="post">
                <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8octavos4'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
                        <div id="fecha1" class="partidos_div">
                ...
                <form action="fixtureFF8.php#confirmar_octavos4" method="post">
                <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8octavos5'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
                        <div id="fecha1" class="partidos_div">
                ...
                <form action="fixtureFF8.php#confirmar_octavos5" method="post">
                <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8octavos6'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
                        <div id="fecha1" class="partidos_div">
                ...
                <form action="fixtureFF8.php#confirmar_octavos6" method="post">
                <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8octavos7'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
                        <div id="fecha1" class="partidos_div">
                ...
                <form action="fixtureFF8.php#confirmar_octavos7" method="post">
                <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8octavos8'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
                        <div id="fecha1" class="partidos_div">
...
<!-- SE TERMINA LA FASE DE OCTAVOS Y COMIENZA LA FASE DE CUARTOS  !-->
            ...
            <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8cuartos1'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
            ...
            <form action="fixtureFF8.php#confirmar_cuartos1" method="post">
            <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8cuartos2'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
                        <div id="fecha2" class="partidos_div">
            ...
            <form action="fixtureFF8.php#confirmar_cuartos2" method="post">
            <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8cuartos3'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
                        <div id="fecha2" class="partidos_div">
            ...
            <form action="fixtureFF8.php#confirmar_cuartos3" method="post">
            <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8cuartos4'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
                        <div id="fecha2" class="partidos_div">
            ...
            <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8semis1'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
            ...
            <form action="fixtureFF8.php#confirmar_semis1" method="post">
            <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8semis2'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
                        <div id="fecha3" class="partidos_div">
...
<!-- TERMINA LA FASE DE SEMIFINALES Y COMIENZA LA FASE FINAL  !-->
            ...
            <?php
                    $conex = conex();
                    $consulta = "SELECT * FROM `partido` WHERE `subetapa` = 'FF8final'";
                    $resultado = mysqli_query($conex,$consulta);
                    if(mysqli_num_rows($resultado) == 0){
                    ?>
                        <div id="fecha3" class="partidos_div">
