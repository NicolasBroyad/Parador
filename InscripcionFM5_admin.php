        ...
        <div id="body">
            ...
            <div id="all_divs">
                ...
                <div id="cuando" class="divs">
                    ...
                    <a href="fixtureFM5.html"> <button type="submit" value="Iniciar" id="editar_fixture"> Editar fixture </button></a>
                    <a href="resultadosFM5.html"> <button type="submit" value="Iniciar" id="cargar_resultados"> Cargar resultados </button></a>
                </div>
