...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="inscripcion_admin.css">
    ...
    <!--BOTON DE INSCRIPCION-->
        ...
        <div id="body">
            <h2 id="titulo"> TORNEO DE FÚTBOL 5 (Femenino)</h2>
            <div id="all_divs">
                <div id="info" class="divs"> 
                    ...
                    <span id="num_partidos"> 5 </span> <img id="partidos" src="img/partidos.png" alt=""> <span id="txt_partidos"> Partidos (Máximo), eliminacion directa</span>
                    <a href="datos_equipo_FM5.html"> <button type="submit" value="Iniciar" id="inscribirse"> Inscribirse </button></a>
                </div>
                <div id="cuando" class="divs">
                    <h4 id="cuando_titulo"> ¿CUANDO SE JUEGA? </h4>
                    <img id="dia" src="img/dia.png" alt=""> <span id="txt_dia"> Todos los Domingos - Desde el 17/7 Hasta el 14/8 </span>
                    <img id="horario" src="img/horario.png" alt=""> <span id="txt_horario"> Entre las 10:00hs y las 17hs </span>
                    <a href="fixtureFF5.html"> <button type="submit" value="Iniciar" id="editar_fixture"> Editar fixture </button></a>
                    <a href="resultadosFF5.html"> <button type="submit" value="Iniciar" id="cargar_resultados"> Cargar resultados </button></a>
                </div>
                <div id="donde" class="divs">
                    ...
                    <span id="canchita_txt"> Cancha Nro.1  (Para 5jugadores) </span>
