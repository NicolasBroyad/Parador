...
<html>
    ...
    <!--BOTON DE INSCRIPCION-->
        ...
        <div id="body">
            <h2 id="titulo"> TORNEO DE FÚTBOL 8 (Masculino)</h2>
            <div id="all_divs">
                ...
                <div id="cuando" class="divs">
                    ...
                    <a href="fixtureFM8.html"> <button type="submit" value="Iniciar" id="editar_fixture"> Editar fixture </button></a>
                    <a href="resultadosFM8.html"> <button type="submit" value="Iniciar" id="cargar_resultados"> Cargar resultados </button></a>
                </div>
