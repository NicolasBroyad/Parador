...
<html>
    ...
    <body>
        ...
        <div id="fixture_div">
            ...
            <span id="fixture_txt"> RESULTADOS FUTBOL FEMENINO 5</span>
        </div>
            ...
            <form action="#" method="post">
                <div  class="partidos_div fecha1">
                    ...
                    <input type="submit" name="8vos_1/8" value="CONFIRMAR" class="confirmar" onclick="validar_resultados('equipo1_8vos1', 'equipo2_8vos1')">
                </div>
            </form>
