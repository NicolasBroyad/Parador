...
<html>
    ...
    <!--BOTON DE INSCRIPCION-->
        ...
        <div id="body">
            <form action="">
                <h2 id="titulo"> <input type="text" name="title" id="input_titulo" placeholder="Título del torneo"> </h2>
                <div id="all_divs">
                    <div id="info" class="divs"> 
                        <h4 id="informacion_titulo"> INFORMACION </h4>
                        <span id="num_jugadores"> </span> <img id="jugadores" src="img/jugadores.png" alt=""> <span id="txt_jugadores"> <input type="number" id="input_num_jugadores" placeholder=""> Jugadores en cancha </span>
                        <span id="num_suplentes"> </span> <img id="suplentes" src="img/suplentes.png" alt=""> <span id="txt_suplentes"> <input type="number" id="input_num_suplentes">  Jugadores suplentes (Máximo) </span>
                        <span id="num_precio"> </span><img id="precio" src="img/precio.png" alt=""><span id="txt_precio"> <input type="number" id="input_num_precio">  Total por partido </span>
                        <span id="num_partidos"> </span> <img id="partidos" src="img/partidos.png" alt=""> <span id="txt_partidos"> <input type="number" id="input_partidos">  Partidos (Máximo), eliminacion directa</span>
                        <a href="datos_equipo_FF8.html"> <button type="submit" value="Iniciar" onclick="validar()"> Crear torneo </button></a>
                    </div>
                    <div id="cuando" class="divs">
                        <h4 id="cuando_titulo"> ¿CUANDO SE JUEGA? </h4>
                        <img id="dia" src="img/dia.png" alt=""> <span id="txt_dia"> Todos los <input type="text" id="input_dia"> - Desde el <input type="date" id="input_fecha_inicial"> Hasta el <input type="date" id="input_fecha_final"> </span>
                        <img id="horario" src="img/horario.png" alt=""> <span id="txt_horario"> Entre las <input type="time" id="input_hora_inicial"> y las <input type="time" id="input_hora_final"> </span>
                    </div>
                    <div id="donde" class="divs">
                        ...
                        <span id="canchita_txt"> Cancha Nro. <input type="number" id="input_numero_cancha"> (Para <input type="number" id="input_numero_jugadores_cancha"> jugadores) </span>
