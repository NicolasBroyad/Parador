        ...
        <div id="body">
            ...
            <div id="all_divs">
                ...
                <div id="cuando" class="divs">
                    ...
                    <a href="fixtureFF8.html"> <button type="submit" value="Iniciar" id="editar_fixture"> Editar fixture </button></a>
                    <a href="resultadosFF8.html"> <button type="submit" value="Iniciar" id="cargar_resultados"> Cargar resultados </button></a>
                </div>
                <div id="donde" class="divs">
                    ...
                    <span id="canchita_txt"> Cancha Nro.2 (Para 8 jugadores) </span>
